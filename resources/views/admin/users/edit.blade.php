...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            ...
            <p class="text-gray-500 text-sm mt-1">Edit data profil warga / petugas / admin</p>
        </div>

        <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-gray-200 pb-4">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Format: JPG, PNG. Maks: 2MB. Kosongkan jika tidak ingin mengubah foto.</p>
