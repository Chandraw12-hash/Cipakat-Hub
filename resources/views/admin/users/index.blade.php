    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center flex-wrap gap-3">
            ...
            <div class="flex gap-2">
                <!-- Tombol Import Excel -->
                <a href="{{ route('import.warga') }}"
                    class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition flex items-center gap-2 shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 7v10c0 2 1.5 3 3 3h10c1.5 0 3-1 3-3V7c0-2-1.5-3-3-3H7c-1.5 0-3 1-3 3z M10 12h4 M12 10v4" />
                    </svg>
                    Import Excel
                </a>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase">Nama / Role
                                </th>
                            ...
                            @foreach ($users as $index => $user)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        <span
                                            class="inline-flex mt-1 px-2 py-0.5 text-xs font-semibold rounded-full
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="text-sm text-gray-400 mt-1">Klik "Import Excel" untuk upload data warga massal, atau "Tambah
                        User" untuk input manual</p>
                </div>
            @endif
        </div>
    </div>
